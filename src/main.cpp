...
unsigned int nStakeMinAge = 720 * 60 * 60;
...
const string strMessageMagic = "Aleph Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Aleph", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1503410415, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "Aleph Market 21 Aug 2017";
        CTransaction txNew;
        txNew.nTime = 1503410415;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1503410415;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 439947 : 439947;
        ...
        assert(block.hashMerkleRoot == uint256("0x7039eb3e83bb0b9e3f5474a33f57dd6913963b3dc858210ef2f6e590c927ed4f"));
...
unsigned char pchMessageStart[4] = { 0x78, 0x89, 0x32, 0x28 };
